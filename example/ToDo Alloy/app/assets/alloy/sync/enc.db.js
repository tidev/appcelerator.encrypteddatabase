var _database = require('appcelerator.encrypteddatabase');
_database.password = 'An excellent password can be used here, such as this string.';
...
module.exports.beforeModelCreate = function(config, name) {
    ...
    if (Ti.Platform.osname === 'mobileweb' || typeof _database === 'undefined') {
